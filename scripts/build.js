#!/usr/bin/env node
// ESM build script (converted from original CommonJS version)
...
function updateRelatedArticles(articles, topN = 5) {
	...
	articles.forEach((article, i) => { article.index = i; });
...
function main() {
	...
	console.log('Updated relatedArticles in', dataPath);
}
...
export { computeSimilarity, updateRelatedArticles };
